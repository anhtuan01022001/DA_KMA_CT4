...
//                cmd.setForeground(new Color(204, 204, 204));
//            }
            else if( month >= MONTH && year >= YEAR){
                cmd.setForeground(new Color(204, 204, 204));
                cmd.setColorSelected(new Color(255,255,255));
...
//            else if(MONTH == m && y ==YEAR && !cmd.getText().equals("") && Integer.valueOf(cmd.getText()) > DAY){
//                cmd.setForeground(new Color(204, 204, 204));
//            }
            
            else if(m >= MONTH && y >=YEAR && !cmd.getText().equals("") ){
                cmd.setForeground(new Color(204, 204, 204));
                
                if(Integer.valueOf(cmd.getText()) < DAY && MONTH == m && y == YEAR ){
                    cmd.setForeground(new java.awt.Color(75, 75, 75));
