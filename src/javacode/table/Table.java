...
import javacode.table.QLMT.TableCellActionQLMT;
import java.awt.Color;
import java.awt.Component;
import java.awt.Font;
import javacode.table.QLKH.ActionQLKH;
    ...
    public Table() {
        ...
        setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable jtable, Object o, boolean selected, boolean focus, int row, int col) {
                 if (o instanceof ModelActionQLMT) {
                    ModelActionQLMT data = (ModelActionQLMT) o;
...
//                        
                 ...
                 else if (o instanceof ModelActionQLKH) {
                    ModelActionQLKH data = (ModelActionQLKH) o;
                    ActionQLKH cell = new ActionQLKH(data);
                    if (selected) {
