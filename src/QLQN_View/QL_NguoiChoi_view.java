...
public   class QL_NguoiChoi_view extends JFrame{
    ...
    public QL_NguoiChoi_view(int id){
...
//        setSize(550, 650);
       ...
       conten.removeAll();
        NC_ThongTin_view thongTin = new NC_ThongTin_view(id); 
       ...
       btnExit.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Panel_QLMT_view.clearRightConstent();
            }
        });
    ...
    public  void ActionLogout(NC_ThongTin_view thongTin){
    ...
    private void Aciton(int id){
        ...
        pCaiDat.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
//                
                NC_CaiDat_view CaiDat = new NC_CaiDat_view(id);
                conten.removeAll();
                conten.add(CaiDat);
                conten.repaint();
                conten.revalidate();
