...
public final class DateChooser extends javax.swing.JPanel {
    ...
    public java.sql.Date toDaySQL(){
        SelectedDate d = getSelectedDate();
        SimpleDateFormat df = new SimpleDateFormat("dd-MM-yyyy");
        Date date = new Date();
        String toDay = df.format(date);
        int DAY = Integer.valueOf(toDay.split("-")[0]);
        int MONTH = Integer.valueOf(toDay.split("-")[1]);
        int YEAR = Integer.valueOf(toDay.split("-")[2]);
        java.sql.Date DateSQL = new java.sql.Date(YEAR-1900,MONTH-1,DAY);
        return DateSQL;
    ...
    public void showPopup() {
        popup.show(textRefernce, 0, textRefernce.getHeight()+3);
    }
    ...
    public java.sql.Date getSelectedDateSQL(){
        SelectedDate d = getSelectedDate();
        
        java.sql.Date DateSQL = new java.sql.Date(d.getYear()-1900,d.getMonth()-1,d.getDay());
        return DateSQL;
